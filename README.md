...
**Note:**
This complete question set is based on the **TCS NQT preparation sheet**, and the list of problems has been taken from the **Take You Forward** website.

A collection of solved and unsolved **Data Structures, Algorithms, Number System, Math & String** problems for practice.
This repository is designed to help beginners strengthen their DSA basics.
...
29. Sum of numbers in a given range
...
20. Change every letter to the next lexicographic alphabet
...
24. Write a program to find a word which has the highest number of repeated letters
25. Change case of each character in a string
26. Concatenate one string to another
27. Write a program to find a substring within a string and display its starting position
